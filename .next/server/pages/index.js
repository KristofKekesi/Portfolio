...
const getStaticProps = async (_)=>{
    ...
    for(let i = 0; i < _config__WEBPACK_IMPORTED_MODULE_8__/* .defaultDockElementIDs.length */ .hU.length; i++){
        const projectResponse = await fetch("/api/projects?id=" + encodeURIComponent(_config__WEBPACK_IMPORTED_MODULE_8__/* .defaultDockElementIDs */ .hU[i]));
...
var __webpack_exports__ = __webpack_require__.X(0, [952,402,508], () => (__webpack_exec__(3678)));
