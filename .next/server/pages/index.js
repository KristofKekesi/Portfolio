...
/* harmony import */ var _functions_project_tooltip_position_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(6128);
/* harmony import */ var _functions_project_tooltip_state_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(1343);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1838);
/* harmony import */ var _functions_api_projects__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(4684);
/* harmony import */ var _functions_api_keywords__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(290);
...
function Home({ dockElements , keywords  }) {
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        //setImageGalleries();
        (0,_functions_project_tooltip_position_js__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z)();
        window.addEventListener("resize", (0,_functions_project_tooltip_position_js__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z)());
        dockElements.map((dockElement)=>{
            (0,_functions_project_tooltip_state_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)(dockElement[0].id);
        });
...
const getStaticProps = async (_)=>{
    ...
    for(let i = 0; i < _config__WEBPACK_IMPORTED_MODULE_8__/* .defaultDockElementIDs.length */ .hU.length; i++){
        const project = await (0,_functions_api_projects__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)(_config__WEBPACK_IMPORTED_MODULE_8__/* .defaultDockElementIDs */ .hU[i]);
        dockElements.push(project);
    }
    const keywords = await (0,_functions_api_keywords__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z)();
    return {
        props: {
...
var __webpack_exports__ = __webpack_require__.X(0, [952,835,509,290], () => (__webpack_exec__(3678)));
