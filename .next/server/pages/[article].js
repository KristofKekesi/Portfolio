...
/* harmony import */ var _functions_project_tooltip_position_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(6128);
/* harmony import */ var _functions_project_tooltip_state_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(1343);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(1838);
/* harmony import */ var _functions_api_articles__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1032);
/* harmony import */ var _functions_api_projects__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(4684);
...
const getStaticPaths = async ()=>{
    const articles = await (0,_functions_api_articles__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)();
    const paths = [];
...
function ArticlePage({ article , dockElements , keywords  }) {
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        (0,_functions_project_tooltip_position_js__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z)();
        dockElements.map((dockElement)=>{
            (0,_functions_project_tooltip_state_js__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Z)(dockElement[0].id);
        });
...
const getStaticProps = async (params)=>{
    const article = await (0,_functions_api_articles__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(undefined, undefined, params.params.article);
    let dockElementIDs;
    ...
    for(let i = 0; i < dockElementIDs.length; i++){
        const project = await (0,_functions_api_projects__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(dockElementIDs[i]);
...
var __webpack_exports__ = __webpack_require__.X(0, [952,835,509,561,863,706], () => (__webpack_exec__(3344)));
