...
export default function Dock(props) {
    return(
        <>
            ...
            <div id="dock" className="blur-dark z-30 fixed inline-block text-primaryLightHover bottom-0 whitespace-nowrap md:bottom-3 left-1/2 p-3 rounded-none md:rounded-2xl">
                <center>
